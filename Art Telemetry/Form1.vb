...
Public Class Form1
    ...
    Private Sub TimerSerial_Tick(sender As Object, e As EventArgs) Handles TimerSerial.Tick
        ...
        If OIL_PRESS < 75 Then
           OilPressChartLabel.ForeColor = System.Drawing.Color.Red
        Else  
           OilPressChartLabel.ForeColor = System.Drawing.Color.Orange
        End If

        If ENGINE_TEMP > 200 Then
          EngineTempLabel.ForeColor = System.Drawing.Color.Red
        Else
          EngineTempLabel.ForeColor = System.Drawing.Color.Transparent
        End If

        If CHASSIS_TEMP > 120 Then
         ChassisTempLabel.ForeColor = System.Drawing.Color.Red
        Else
         ChassisTempLabel.ForeColor = System.Drawing.Color.Transparent
        End If
